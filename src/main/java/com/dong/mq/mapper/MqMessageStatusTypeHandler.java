package com.dong.mq.mapper;

import com.dong.mq.enums.MqMessageStatus;
...
public class MqMessageStatusTypeHandler extends BaseTypeHandler<MqMessageStatus> {
     ...
     */
    @Override
    public void setNonNullParameter(PreparedStatement ps, int i, MqMessageStatus parameter, JdbcType jdbcType) throws SQLException {
