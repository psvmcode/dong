package com.dong.replica.config;
...
public class MariaDbConfig {
     ...
     * url。
     */
    @Value("${dong.mariadb.url}")
    private String url;

    /**
     * username。
     */
    @Value("${dong.mariadb.username}")
    private String username;

    /**
     * password。
     */
    @Value("${dong.mariadb.password}")
    private String password;

    /**
     * driverClassName。
     */
    @Value("${dong.mariadb.driver-class-name:org.mariadb.jdbc.Driver}")
